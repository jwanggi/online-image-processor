    ...
    imageproc.kuwahara = function (inputData, outputData, size) {
        ...
        for (var y = 0; y < inputData.height; y++) {
            for (var x = 0; x < inputData.width; x++) {
                ...
                var regionA = regionStat(x - kernelRadius, y - kernelRadius, inputData);
                var regionB = regionStat(x + kernelRadius, y - kernelRadius, inputData);
                var regionC = regionStat(x - kernelRadius, y + kernelRadius, inputData);
                var regionD = regionStat(x + kernelRadius, y + kernelRadius, inputData);
